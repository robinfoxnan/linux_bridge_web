<template>
    <div id="test4">
        ...
        <el-table :data="tableDataPort" border style="width: 100%" :row-class-name="tableRowClassName">
            ...
            <el-table-column prop="master" label="所属桥"> </el-table-column>
        ...
        <div>
            ...
            <el-dialog title="网口IP设置" :visible.sync="dialogFormVisible" width="50%">
                ...
                <el-form :model="form">
                    ...
                    <el-form-item label="当前桥/网口:" :label-width="formLabelWidth">
                        {{ form.info }}
                    </el-form-item>

                    <el-form-item label="IPV4地址/掩码" :label-width="formLabelWidth">
                        <el-input v-model="form.ipv4" class="search_input" placeholder="any or 0.0.0.0/24"
                            autocomplete="off"></el-input>
                    </el-form-item>

                    <el-form-item label="网关地址/掩码" :label-width="formLabelWidth">
                        <el-input v-model="form.gwip" class="search_input" placeholder="any or 0.0.0.0/24"
                            autocomplete="off"></el-input>
                    </el-form-item>
